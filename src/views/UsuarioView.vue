        ...
        <div id="wrapper">
          ...
          >
            ...
            >
              ...
              <div class="sidebar-brand-text mx-3">SISTEMA DE <sup>VENTA</sup></div>
            </a>
            ...
            <li class="nav-item">
              ...
              >
                <div class="bg-white py-2 collapse-inner rounded">
                  ...
                  <RouterLink to="/empleados" class="collapse-item">Historial de Empleados</RouterLink>
                </div>
              </div>
            </li>
            ...
            <footer class="sticky-footer bg-white">
              <div class="container my-auto">
                <div class="copyright text-center my-auto">
                  <span>Copyright &copy; Saul Beisaga 2024</span>
                </div>
              </div>
            </footer>
          </div>
